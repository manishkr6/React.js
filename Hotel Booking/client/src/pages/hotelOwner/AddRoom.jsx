  ...
  return (
    <form>
      <Title
        ...
        font="outfit"
        title="Add Room"
        subTitle="Fill in the details carefully and accurate room details, pricing, and amenities, to enhance the user bookings experiences."
      />
      ...
      <button className="bg-blue-600 text-white py-2 px-4 rounded mt-4 hover:bg-blue-700 transition duration-300 cursor-pointer">
        Add Room
      </button>
    </form>
  );
